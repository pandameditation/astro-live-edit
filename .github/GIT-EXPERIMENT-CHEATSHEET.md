...
[alias]
	exp-start = "!f() { \n  # Check for uncommitted changes on current branch\n  if [[ -n $(git status -s) ]]; then\n    CURRENT=$(git branch --show-current);\n    echo \"📝 Uncommitted changes detected on $CURRENT\";\n    echo \"\";\n    echo \"What do you want to do?\";\n    echo \"  1) Commit changes to $CURRENT (keep branches isolated)\";\n    echo \"  2) Take changes to new branch (migrate work)\";\n    echo \"  3) Discard changes\";\n    echo -n \"Enter choice (1, 2, or 3): \";\n    read CHOICE;\n    \n    case $CHOICE in\n      1)\n        echo -n \"Commit message (or press Enter for default): \";\n        read commit_msg;\n        if [ -z \"$commit_msg\" ]; then\n          commit_msg=\"WIP: Auto-commit before switching to new experiment\";\n        fi;\n        git add -A || exit 1;\n        git commit -m \"$commit_msg\" || exit 1;\n        echo \"✓ Changes committed on $CURRENT\";\n        ;;\n      2)\n        echo \"✓ Taking changes to new branch...\";\n        ;;\n      3)\n        echo \"⚠️  Stashing changes (recoverable with git stash pop)\";\n        git stash push -u -m \"exp-start stash from $CURRENT at $(date +%Y-%m-%d_%H:%M:%S)\";\n        echo \"✓ Changes stashed\";\n        ;;\n      *)\n        echo \"Invalid choice. Cancelled.\";\n        exit 1;\n        ;;\n    esac;\n  fi;\n  \n  git switch -c \"exp/$1-try#1\" || exit 1; \n  echo \"✓ Experiment started: exp/$1-try#1\"; \n  git exp-status;\n}; f"
	exp-switch = "!f() { \n  # Check for uncommitted changes on current branch\n  if [[ -n $(git status -s) ]]; then\n    CURRENT=$(git branch --show-current);\n    TARGET=\"$1\";\n    echo \"📝 Uncommitted changes detected on $CURRENT\";\n    echo \"\";\n    echo \"What do you want to do?\";\n    echo \"  1) Commit changes to $CURRENT (keep branches isolated)\";\n    echo \"  2) Take changes to $TARGET (migrate work)\";\n    echo \"  3) Stash changes (recoverable later)\";\n    echo -n \"Enter choice (1, 2, or 3): \";\n    read CHOICE;\n    \n    case $CHOICE in\n      1)\n        echo -n \"Commit message (or press Enter for default): \";\n        read commit_msg;\n        if [ -z \"$commit_msg\" ]; then\n          commit_msg=\"WIP: Auto-commit before switching branches\";\n        fi;\n        git add -A || exit 1;\n        git commit -m \"$commit_msg\" || exit 1;\n        echo \"✓ Changes committed on $CURRENT\";\n        ;;\n      2)\n        echo \"✓ Taking changes to $TARGET...\";\n        ;;\n      3)\n        echo \"⚠️  Stashing changes (recoverable with git stash pop)\";\n        git stash push -u -m \"exp-switch stash from $CURRENT at $(date +%Y-%m-%d_%H:%M:%S)\";\n        echo \"✓ Changes stashed\";\n        ;;\n      *)\n        echo \"Invalid choice. Cancelled.\";\n        exit 1;\n        ;;\n    esac;\n  fi;\n  \n  git switch \"$1\" || exit 1; \n  echo \"✓ Switched to: $1\";\n  git exp-status;\n}; f"
